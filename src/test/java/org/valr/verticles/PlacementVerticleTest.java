...
public class PlacementVerticleTest {
    ...
    void setUp(Vertx vertx, VertxTestContext testContext) {
        ...
        PlacementVerticle orderBookVerticle = new PlacementVerticle(router, authMiddleware, placementService);
    ...
    void testPlaceLimitOrderSuccess(Vertx vertx, VertxTestContext testContext) {
        ...
        when(placementService.placeLimitOrder(any())).thenReturn(new JsonObject());
    ...
    void testPlaceLimitOrderFails(Vertx vertx, VertxTestContext testContext) {
        ...
        when(authMiddleware.getUserIdFromContext(any())).thenReturn("user123");
        when(placementService.placeLimitOrder(any())).thenReturn(errorResponse);
